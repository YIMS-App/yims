...
export default function CalendarScreen ({ navigation, params }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        style={{ backgroundColor: '#3159C4', height: screenWidth }}
        data={monthMatches}
          ...
          return (
            <View style={{ flexDirection: 'row', padding: 6, justifyContent: 'space-between', alignItems: 'center' }}>
              <Text style={[styles.body, styles.userMatchData]}>
                {itemData.item.college1Abbrev} vs. {itemData.item.college2Abbrev} @{' '}
                {itemData.item.startTime.slice(0, 10)}
