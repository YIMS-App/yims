...
def query_db(query, params=None):
    ...
    return results
#-----------------------------------------------------------------------
@api.route("/totalscores", methods=["GET"])
...
@api.route("/getpastmatches", methods=["GET"])
...
@api.route("/getfuturematches", methods=["GET"])
...
@api.route("/getunscoredmatches", methods=["GET"])
...
@api.route("/updatematch", methods=["POST"])
def updatematch():
    """
...
@api.route("/casauth", methods=["POST"])
def casauth():
    """
    CAS Authentication
    """
...
@api.route("/userperms", methods=["POST"])
def userperms():
    """
...
@api.route("/getmanager", methods=["POST"])
def getmanager():
    """
...
@api.route("/betprofit", methods=["POST"])
def betprofit():
    """
...
@api.route("/aggregatebet", methods=["POST"])
def betprofit():
    """
...
@api.route("/updateparticipation", methods=["POST"])
